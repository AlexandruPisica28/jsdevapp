<template>
  <div class="container mt-5">
    ...
    <div class="row">
      <div v-for="(user, index) in users.filters(u=> u.status)  "
        :key="index"
         @click="setActiveUser(user, index)"
      >


        <div class="col-sm-3" v-for="(user, index) in users.filters(u=>u.status)" :key="index" @click="setActiveUser(user, index)">
          <div v-if="user.status" class="card">
            <div class="card-body">
              ...
              <router-link :to="'/userdetails/' + user.id" class="btn btn-outline-primary me-2 mt-2">View
                more</router-link>
              <!-- <router-link
